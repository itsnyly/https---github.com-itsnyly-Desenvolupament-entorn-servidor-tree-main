...
<body>
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        print_r($_POST);
        echo "</pre>";
        header("Location: http://localhost/desenvolupament-entorn-servidor/formularis/autenticacioUsuaris/part1/p1.php");
    } else {
        //Pintar el formulari
    ...
    <h3>My form</h3>
    <form action="patroPGR.php" method="post" id="myform" name="myform">
